...
export const TokenDecode=async (req, res) => {
    let result= DecodeToken("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVuZ3IucmFiYmlsQHlhaG9vLmNvbSIsInVzZXJfaWQiOiIxMjMiLCJpYXQiOjE3MzA4MjE5OTcsImV4cCI6MTczMzQxMzk5N30.mpKzoD7C1aA4KmgmjeiynyULtxWowOPI_3LgUTfO7Eo")
    res.json({token:result});
}

export const Email=async (req, res) => {
        let EmailTo="cseahmed01@gmail.com"
